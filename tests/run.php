...
mySlider_test_assert( '1.0.0' === MY_SLIDER_PRO_VERSION, 'The version constant is not 1.0.0.' );
...
mySlider_test_contains( 'Version:           1.0.0', $plugin_source, 'The plugin header version is incorrect.' );
mySlider_test_contains( 'Stable tag: 1.0.0', $readme_source, 'The readme stable tag is incorrect.' );
...
mySlider_test_assert( 'dashicons-slides' === ( $menu_page['icon_url'] ?? '' ), 'The slider menu needs a valid bundled Dashicons icon.' );
...
echo 'MY Slider PRO v1.0.0 slider behavior tests passed' . PHP_EOL;
