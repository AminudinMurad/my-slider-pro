...
mySlider_test_assert( '1.0.6' === MY_SLIDER_PRO_VERSION, 'The version constant is not 1.0.6.' );
...
mySlider_test_contains( 'Version:           1.0.6', $plugin_source, 'The plugin header version is incorrect.' );
mySlider_test_contains( 'Stable tag: 1.0.6', $readme_source, 'The readme stable tag is incorrect.' );
...
echo 'MY Slider PRO v1.0.6 slider behavior tests passed' . PHP_EOL;
